    ...
    <div className='filteroptions'>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>New York, NY $120K -  $150K 2024-12-01 
          <span className='jobtypetag'>Full time</span>
          <span className='depttag'>Technology</span></div>
      ...
      <div className='jobinfo'>
       <div className='titlecard'>
        ...
        <div className='jobdetails'>San Francisco, CA $130K -  $160K 2024-12-03 
          <span className='jobtypetag'>Full time</span>
          <span className='depttag'>Management</span></div>
      ...
      <div className='jobinfo'>
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Boston, MA $110K -  $140K 2024-11-28 
          <span className='jobtypetag'>Full time</span>
          <span className='depttag'>Technology</span></div>
      ...
      <div className='jobinfo'>
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Austin, TX $100K -  $130K 2024-11-20 
          <span className='jobtypetag'>Full time</span>
          <span className='depttag'>Technology</span></div>
      ...
      <div className='jobinfo'>
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Chicago, IL $15 -  $18/hr 2024-12-04 
          <span className='jobtypetag'>Part-time</span>
          <span className='depttag'>Sales</span></div>
      ...
      <div className='jobinfo'>
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Chicago, IL $90K -  $120K 2024-12-02 
          <span className='jobtypetag'>Full time</span>
          <span className='depttag'>Marketing</span></div>
