...
const Tutors = () => {
  return (
    <div className='dashboard-container'>
      <span className='instituteheading'>Tutors</span>
      <span className='institutedesc'>
        Book 1-on-1 sessions with expert tutors • 1 hour slots available
      </span>
      ...
      <div className='tutorrow'>
          ...
          <div className='tutorinfo'>
            <div className='companyinfohead'>
              ...
              <div className='companytitle'>
                ...
                <br></br>
                <span className='companyindustry'>React Development</span>{' '}
                <br></br>
                <span className='companyindustry'>
                  4.9 | 1250 Sessions | 10 Years Exp{' '}
                </span>{' '}
              </div>
            </div>
            ...
            <div className='skillset'>
              ...
              <span className='skilltag'>Webperformance</span>
              <span className='skilltag'>+1 More</span>
            </div>
            <div className='tutorborderline'></div>
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹80 <span className='companyindustry'>/hour</span>
              </div>
        ...
        <Link to='micheal-chen'>
          <div className='tutorinfo'>
            ...
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹75 <span className='companyindustry'>/hour</span>
              </div>
              <div className='availabletag'>Available</div>
            </div>
          </div>
      ...
      <div className='tutorrow'>
        <Link to='emily-rodriguez'>
          <div className='tutorinfo'>
            ...
            <div className='skillset'>
              ...
              <span className='skilltag'>Darabase Design</span>
              <span className='skilltag'>+1 More</span>
            </div>
            <div className='tutorborderline'></div>
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹70 <span className='companyindustry'>/hour</span>
              </div>
              <div className='availabletag'>Available</div>
            </div>
          </div>
        ...
        <Link to='david-kumar'>
          <div className='tutorinfo'>
            ...
            <div className='skillset'>
              {' '}
              <span className='skilltag'>Mobile Development</span>
            ...
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹65 <span className='companyindustry'>/hour</span>
              </div>
              <div className='availabletag'>Available</div>
            </div>
          </div>
      ...
      <div className='tutorrow'>
          ...
          <div className='tutorinfo'>
            <div className='companyinfohead'>
              ...
              <div className='companytitle'>
                ...
                <span className='skilltag'>Busy</span>{' '}
              </div>
            </div>
            ...
            <div className='skillset'>
              ...
              <span className='skilltag'>Product Design</span>
              <span className='skilltag'>+1 More</span>
            </div>
            <div className='tutorborderline'></div>
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹85 <span className='companyindustry'>/hour</span>
              </div>
            </div>
          </div>
        </Link>
        <Link to='james wilson'>
          <div className='tutorinfo'>
            ...
            <div className='skillset'>
              {' '}
              <span className='skilltag'>DevOps</span>
            ...
            <div className='bottomstats'>
              <div className='Pricetag'>
                ₹60 <span className='companyindustry'>/hour</span>
              </div>
            </div>
          </div>
        </Link>
