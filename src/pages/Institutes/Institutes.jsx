...
const Institutes = () => {
  return (
    <div className='dashboard-container'>
      ...
      <span className='institutedesc'>Manage coaching institutes and personal trainers offering virtual/physical training</span>
      ...
      <div className='institutestats'>
        ...
        <div className='totalinstitutes'>
          <div className='institutestathead'>
          <div className='totalinternshipsicon1'></div> <span className='count'> 993 </span> </div>
      ...
      <div className='institutefilters'>
        <div className='instutefilterssub'> <div className='totalinternshipsicon1'></div> 
      ...
      <div className='companyrow'>
        ...
        <div className='institutename'>TechMaster Academy <span className='activetag'>Pro</span>
        <div className='instituteicon'></div></div>
        ...
        <br></br>
        <div className='skillset'> <span className='skilltag'>Full Stack Development</span>
        ...
        <div className='companyinfo'>
          <div className='institutename'>Sarah Williams<span className='activetag'>Pro</span>
        <div className='instituteicon'></div></div>
        ...
        <br></br>
        <div className='skillset'> <span className='skilltag'>React Development</span>
      ...
      <div className='companyrow'>
        <div className='companyinfo'>
        <div className='institutename'>CodeCraft Institute <span className='activetag'>Pro</span>
        <div className='instituteicon'></div></div>
        <span className='institutedesc'>Coaching Institute</span> <br></br>
        <br></br>
        ...
        <br></br>
        <div className='skillset'> <span className='skilltag'>Mobile App Development</span>
        ...
        <div className='companyinfo'>
          <div className='institutename'>David Rodriguez<span className='activetag'>Pro</span>
        <div className='instituteicon'></div></div>
        <span className='institutedesc'>Personal Trainer</span> <br></br>
        <br></br>
        ...
        <br></br>
        <div className='skillset'> <span className='skilltag'>Python</span>
      ...
      <div className='companyrow'>
        <div className='companyinfo'>
        <div className='institutename'>Digital Skills Academy 
        <div className='instituteicon'></div></div>
        <span className='institutedesc'>Coaching Institute</span> <br></br>
        <br></br>
        ...
        <span className='skilltag'>Cold Lead</span> 
        <br></br>
        <div className='skillset'> <span className='skilltag'>Digital Marketing</span>
        ...
        <div className='companyinfo'>
          <div className='institutename'>Alex Kumar<span className='activetag'>Pro</span>
        <div className='instituteicon'></div></div>
        <span className='institutedesc'>Personal Trainer</span> <br></br>
        <br></br>
        ...
        <br></br>
        <div className='skillset'> <span className='skilltag'>Backend Development</span>
