  ...
  return (
    <div className='dashboard-container'>
      ...
      <span className='institutedesc'>
        Browse courses published by institutes and personal trainers with
        complete details
      </span>
      ...
      <div className='companyrow'>
        <Link to='complete-full-stack-web-development-bootcamp'>
          <div className='companyinfo'>
            <div className='institutename'>
              Complete Full Stack Web Development Bootcamp
              <span className='skilltag'>Bestseller</span>
            </div>
            <span className='institutedesc'>by TechMaster Academy</span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              4.8 | 1,250 Students | 16 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Master modern web development from frontend to backend. Build
              real-world projects using React, Node.js, and MongoDB.
            </span>
            <br></br>
        ...
        <Link to='advance-react-performance-optimization'>
          <div className='companyinfo'>
            <div className='institutename'>
            ...
            <br></br>
            <span className='institutedesc'>
              4.9 | 340 Students | 6 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Deep dive into React performance optimization techniques. Learn
              advanced patterns, profiling, and best practices for building.
            </span>
            <br></br>
            <div className='skillset'>
              {' '}
              <span className='skilltag'>React Profiler</span>
      ...
      <div className='companyrow'>
        <Link to='mobile-app-development-with-react-native'>
          <div className='companyinfo'>
            <div className='institutename'>
              Mobile App Development with React Native
              <span className='skilltag'>Bestseller</span>
            </div>
            <span className='institutedesc'>by CodeCraft Institute</span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              4.7 | 890 Students | 12 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Build native mobile apps for iOS and Android using React Native.
              Learn navigation, animations, native modules, and app development.
            </span>
            <br></br>
            <div className='skillset'>
              {' '}
        ...
        <Link to='backend-development-with-node.Js-and-express'>
          <div className='companyinfo'>
            <div className='institutename'>
            ...
            <br></br>
            <span className='institutedesc'>
              4.8 | 580 Students | 10 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Comprehensive course on building scalable backend systems. Learn
              Node.js, Express, databases, authentication, and API development.
            </span>
            <br></br>
            <div className='skillset'>
              {' '}
      ...
      <div className='companyrow'>
        <Link to='data-structures-and-algorithms-masterclass'>
          <div className='companyinfo'>
            <div className='institutename'>
            ...
            <br></br>
            <span className='institutedesc'>
              4.9 | 1,450 Students | 14 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Master essential data structures and algorithms. Perfect
              preparation for technical interviews at top tech companies.
            </span>
            <br></br>
            <div className='skillset'>
              {' '}
              <span className='skilltag'>Arrays</span>
        ...
        <Link to='cloud-computing'>
          <div className='companyinfo'>
            ...
            <br></br>
            <span className='institutedesc'>
              4.7 | 720 Students | 8 Weeks{' '}
            </span>{' '}
            <br></br>
            <br></br>
            <span className='institutedesc'>
              Complete AWS cloud practitioner to solutions architect path. Learn
              EC2, S3, Lambda, DynamoDB, and more.
            </span>
            <br></br>
            <div className='skillset'>
              {' '}
              <span className='skilltag'>EC2</span>
