  ...
  return (
    <div className='dashboard-container'>
      <div className='jobheader'>
        ...
        <button className='addjob'> + Add New Internship </button>
      </div>
      ...
      <div className='internshipfilteroptions'>
        <div className='internshipfilters'>
          ...
          <div className='internshiptype'>
            <span>Subscription Plans </span><br></br>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>New York, NY 3 Months $25/hr Starts: 2025-01-15 
          <span className='depttag'>Technology</span>
          <span className='protag'>5 spots</span>
          </div>
        <div className='applicationstag'>112 Applications • Posted 2024-12-01</div>
       </div>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Remote 3 Months $20/hr Starts: 2025-06-01 
          <span className='depttag'>Marketing</span>
          <span className='protag'>3 spots</span>
          </div>
        <div className='applicationstag'>89 Applications • Posted 2024-12-04</div>
       </div>
        <div className='jobactions'>
        <span className='activetag'>Active</span>
        <div className='editoption'></div>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Austin, TX 6 Months $18/hr Starts: 2025-02-01 
          <span className='depttag'>Design</span>
          <span className='protag'>2 spots</span>
          </div>
        <div className='applicationstag'>67 Applications • Posted 2024-12-05</div>
       </div>
        <div className='jobactions'>
        <span className='activetag'>Active</span>
        <div className='editoption'></div>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Bostan, MA 4 Months $30/hr Starts: 2025-01-20 
          <span className='depttag'>Technology</span>
          <span className='protag'>4 spots</span>
          </div>
        <div className='applicationstag'>145 Applications • Posted 2024-11-28</div>
       </div>
        <div className='jobactions'>
        <span className='activetag'>Active</span>
        <div className='editoption'></div>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>SanFrancisco, CA 3 Months $22/hr Starts: 2025-01-10 
          <span className='depttag'>Design</span>
          <span className='protag'>2 spots</span>
          </div>
        <div className='applicationstag'>78 Applications • Posted 2024-12-03</div>
       </div>
        <div className='jobactions'>
        <span className='activetag'>Active</span>
        <div className='editoption'></div>
      ...
      <div className='job1'>
       ...
       <div className='titlecard'>
        ...
        <div className='jobdetails'>Chicago, IL 6 Months $28/hr Starts: 2025-02-15 
          <span className='depttag'>Finance</span>
          <span className='protag'>6 spots</span>
          </div>
        <div className='applicationstag'>134 Applications • Posted 2024-12-02</div>
       </div>
        <div className='jobactions'>
        <span className='activetag'>Active</span>
        <div className='editoption'></div>
